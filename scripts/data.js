const DesktopSliderImage1 = "../images/desktop-image-hero-1";
const DesktopSliderImage2 = "../images/desktop-image-hero-2";
const DesktopSliderImage3 = "../images/desktop-image-hero-3";

const data = {
  slide1: {
    image: DesktopSliderImage1,
